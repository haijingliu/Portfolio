...
<div id="project_wrapper">
      ...
      <section id="work_content">
            <article id="work_details">
                 ...
                 <p>This project uses this object as a form to trigger an intriguing interaction with internet data, which subverts the interaction between modern electronic devices and their users, hence drawing an effective connection among data and its internet users.</p>
                 ...
                 <p>This project is also my little satirical concern on how modern technology (either the social media networks or the devices) shaping humanbeings interaction modes with both gadgets and social-networking ties. So I decided to use the most emergent and efficient technology to create this inefficient but poet interaction modes.</p>
                 <p>I would like to invite many more friends to experience.</p>
            ...
            <p>Special thanks to  <br> <a href="http://jos.ph">Joe Saavedra</a> <a href="http://owenherterich.com/">Owen Herterich</a><br>for technology instructions and guidance</p>
            <p>Development Credits <br> <a href="http://wentin.co/">Wengting Zhang</a><br>for twitterstream API methodology implement</p>

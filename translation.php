...
<div id="project_wrapper">
      <section id="work_content">
        <article id="work_details">
                  <h2>Translation</h2>
                  <h3>Graphic / Print / Image Process</h3>
                  <p1>
               Capturing the intangible, this collection freezes energy in time, creating a discourse between the seen and the unseen. 
               aiming to harness the mystique of the omnipresent that's often forgotten,
               certain aspects are isolated to represent the broad spectrum of our lives. </p>
               This project is in collaboration with Fabiona Einhorn and  <a style=text-decoration:none!important href="http://angelicajang.com/">Angelica Jang</a>
               under the direction of Caspar Lam and YuJune Park of <a style=text-decoration:none!important href="http://www.synopticoffice.com/">Synoptic Office</a>
               The book compiled our experimenting outputs in the digital manipulations of the subject "spectrum". 
                  </p1>
            </article>
               </section>

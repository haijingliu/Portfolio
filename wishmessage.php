...
<div id="project_wrapper">
     ...
     <article id="work_details"> 
                 ...
                 <p1><p>Users, networks, information have given a basic structure of the network dynamics; it forms a society.
                 ...
                 manifested a planetary meta-organism. Virtual human behaviors have been building up the community eternally. Virtual communities
                 that has improved the efficiency and quality of internet communications and also has triggered complex emotions and real consequences constantly.
                 In this case, I am studying the physical boundaires of virtual networks, and try to explore if there’s a possible way to reform the user generated data in a sensible entity.
                 ...
                 The bamboo copter in east asia,contains a metaphor of good blessing.</p>
    ...
    <article id ="project_features">
            ...
            <p>Thesis Instructor  <br><a style="text-decoration:none;color:black;" href="http://www.melaniecrean.com/" >Melanie Crean</a> and <a style="text-decoration:none;color:black;" href="http://www.andrewzornoza.com/">Andrew Zornoza</a></p>
            <p>Special thanks to  <br><a style="text-decoration:none;color:black;" href="http://jos.ph">Joe Saavedra</a> and <a style="text-decoration:none;color:black;" href="http://wentin.co/">Wengting Zhang</a>
            <br></p>
            </div> 
            <div id="links">
            <a style="text-decoration:none;color:black;" target="_blank"  href="http://haijing.info">Website.</a>
            <a style="text-decoration:none;color:black;" target="github"  href="https://github.com/haijingliu/Thesis">Source Code</a>
            </div>
  </article>
...
<section id="Project_Content">
            <article id="Content">
                 ...
                 <img src="img/imgs/copterwish/interface.jpg">   
                  ...
                  <iframe src="//player.vimeo.com/video/95751766?color=c9ff23&byline=0&portrait=0" 
                  width="345" height="225" frameborder="0" 
